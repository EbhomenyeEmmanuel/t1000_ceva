...
import com.example.t1000_ceva.databinding.FragmentFourthPayBillsPageBinding
...
@AndroidEntryPoint
class FourthPayBillsPageFragment : Fragment(R.layout.fragment_fourth_pay_bills_page) {
    private val binding by viewBinding<FragmentFourthPayBillsPageBinding>()
